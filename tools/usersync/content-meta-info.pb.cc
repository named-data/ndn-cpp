...
void protobuf_AssignDesc_content_2dmeta_2dinfo_2eproto() {
  ...
  static const int ContentMetaInfoMessage_ContentMetaInfo_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ContentMetaInfoMessage_ContentMetaInfo, content_size_),
...
void protobuf_AddDesc_content_2dmeta_2dinfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "p\030\202\001 \002(\004\022\025\n\014content_size\030\203\001 \002(\004\022\016\n\005other"
...
const int ContentMetaInfoMessage_ContentMetaInfo::kContentSizeFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 130: {
        ...
        if (input->ExpectTag(1048)) goto parse_content_size;
        break;
      }
...
void ContentMetaInfoMessage_ContentMetaInfo::SerializeWithCachedSizes(
  ...
  // required uint64 content_size = 131;
  if (has_content_size()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(131, this->content_size(), output);
  }
...
::google::protobuf::uint8* ContentMetaInfoMessage_ContentMetaInfo::SerializeWithCachedSizesToArray(
  ...
  // required uint64 content_size = 131;
  if (has_content_size()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(131, this->content_size(), target);
  }
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<ContentMetaInfoMessage_ContentMetaInfo*>(16)->f) - \
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(ContentMetaInfoMessage_ContentMetaInfo, f) \
...
// required uint64 content_size = 131;
bool ContentMetaInfoMessage_ContentMetaInfo::has_content_size() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
void ContentMetaInfoMessage_ContentMetaInfo::set_has_content_size() {
  _has_bits_[0] |= 0x00000004u;
}
void ContentMetaInfoMessage_ContentMetaInfo::clear_has_content_size() {
  _has_bits_[0] &= ~0x00000004u;
}
void ContentMetaInfoMessage_ContentMetaInfo::clear_content_size() {
  content_size_ = GOOGLE_ULONGLONG(0);
  clear_has_content_size();
}
 ::google::protobuf::uint64 ContentMetaInfoMessage_ContentMetaInfo::content_size() const {
  // @@protoc_insertion_point(field_get:ndn_message.ContentMetaInfoMessage.ContentMetaInfo.content_size)
  return content_size_;
}
 void ContentMetaInfoMessage_ContentMetaInfo::set_content_size(::google::protobuf::uint64 value) {
  set_has_content_size();
  content_size_ = value;
