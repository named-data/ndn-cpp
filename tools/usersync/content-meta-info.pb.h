...
class ContentMetaInfoMessage_ContentMetaInfo : public ::google::protobuf::Message {
 public:
  ...
  // required uint64 content_size = 131;
  inline bool has_content_size() const;
  inline void clear_content_size();
  static const int kContentSizeFieldNumber = 131;
...
// required uint64 content_size = 131;
inline bool ContentMetaInfoMessage_ContentMetaInfo::has_content_size() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ContentMetaInfoMessage_ContentMetaInfo::set_has_content_size() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ContentMetaInfoMessage_ContentMetaInfo::clear_has_content_size() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ContentMetaInfoMessage_ContentMetaInfo::clear_content_size() {
  content_size_ = GOOGLE_ULONGLONG(0);
  clear_has_content_size();
}
inline ::google::protobuf::uint64 ContentMetaInfoMessage_ContentMetaInfo::content_size() const {
  return content_size_;
}
inline void ContentMetaInfoMessage_ContentMetaInfo::set_content_size(::google::protobuf::uint64 value) {
...
inline ::google::protobuf::uint64 ContentMetaInfoMessage_ContentMetaInfo::content_size() const {
  // @@protoc_insertion_point(field_get:ndn_message.ContentMetaInfoMessage.ContentMetaInfo.content_size)
  return content_size_;
}
inline void ContentMetaInfoMessage_ContentMetaInfo::set_content_size(::google::protobuf::uint64 value) {
  set_has_content_size();
  content_size_ = value;
  // @@protoc_insertion_point(field_set:ndn_message.ContentMetaInfoMessage.ContentMetaInfo.content_size)
}
...
class ContentMetaInfoMessage_ContentMetaInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ndn_message.ContentMetaInfoMessage.ContentMetaInfo) */ {
 public:
  ...
  static const int kContentSizeFieldNumber = 131;
  ::google::protobuf::uint64 content_size() const;
  void set_content_size(::google::protobuf::uint64 value);
