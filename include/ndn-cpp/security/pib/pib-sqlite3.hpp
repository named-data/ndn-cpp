 ...
 * @author: From ndn-cxx security https://github.com/named-data/ndn-cxx/blob/master/src/security/pib/pib-sqlite3.hpp
 *
...
public:
   ...
   * @throw PibImpl::Error if initialization fails.
   */
  PibSqlite3
