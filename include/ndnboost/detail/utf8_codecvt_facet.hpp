...
protected:
    ...
    virtual bool do_always_noconv() const NDNBOOST_NOEXCEPT_OR_NOTHROW {
        return false;
    }
    ...
    virtual int do_encoding() const NDNBOOST_NOEXCEPT_OR_NOTHROW {
    ...
    virtual int do_max_length() const NDNBOOST_NOEXCEPT_OR_NOTHROW {
