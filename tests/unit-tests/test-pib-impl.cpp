...
// TODO: Move PibDataFixture to a separate file.
...
public:
  ...
  ptr_lib::shared_ptr<CertificateV2> id1Key1Cert1;
  ptr_lib::shared_ptr<CertificateV2> id1Key1Cert2;
  ptr_lib::shared_ptr<CertificateV2> id1Key2Cert1;
  ptr_lib::shared_ptr<CertificateV2> id1Key2Cert2;
  ptr_lib::shared_ptr<CertificateV2> id2Key1Cert1;
  ptr_lib::shared_ptr<CertificateV2> id2Key1Cert2;
  ptr_lib::shared_ptr<CertificateV2> id2Key2Cert1;
  ptr_lib::shared_ptr<CertificateV2> id2Key2Cert2;
